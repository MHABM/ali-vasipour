        ...
        <div className='footer'>
            <div className='footerTop'>
                <div className='footerRight'>
                    ...
                    <div className='rightItem' onClick={()=>document.getElementById("textScroll").scrollIntoView({behavior:'smooth'})}>درباره دندانپزشک</div>
                ...
                <div className='footerLeft'>
                    ...
                    <div className='contactItem'><Room style={{marginLeft:'10px'}}/>خیابان ولیعصر، قبل از تقاطع مطهری، ساختمان رادکام، طبقه دوم</div>
                    <div className='contactItem'><Phone style={{marginLeft:'10px'}}/>تماس با ما: ۴۴۰۴۲۳۷۵-۰۲۱</div>
                    <div className='contactItem'><MailOutline style={{marginLeft:'10px'}}/>FastDent.ir@gmail.com</div>
                </div>
            </div>
            <div className='footerBottom'>
                <div className='bottomTop'>© 2023 FastDent. | Privacy Policy | Made with<Favorite style={{fontSize:'1.3rem',margin:'0 5px',verticalAlign: '-0.25em'}}/>and<Whatshot style={{fontSize:'1.3rem',margin:'0 5px',verticalAlign: '-0.25em'}} /> in Babol </div>
